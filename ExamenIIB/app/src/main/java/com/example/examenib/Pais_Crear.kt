...
class Pais_Crear : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val spinnerPaisONU=findViewById<Spinner>(R.id.spEsONU)
        ...
        btnSavePais
            .setOnClickListener{
                ...
                try {
                    ...
                    val nombrePais = findViewById<EditText>(R.id.etxNomPais)
                    val pibPais = findViewById<EditText>(R.id.etxPIB)
                    ...
                    db.paisApp?.crearPais(paisNuevo)
